                    ...
                    "functions": {
                        ...
                        "items": {
                            ...
                            "properties": {
                                ...
                                "loops": {
                                    ...
                                    "items": {
                                        ...
                                        "properties": {
                                            ...
                                            "parent_node_id": {"type": ["integer", "null"]},
                                            "category": {
                                                "type": ["string", "null"],
                                                "enum": ["simple", "nested", "dynamic", None],
                                            },
                                            "depth": {"type": ["integer", "null"]},
                                            "index_direction": {
                                                "type": ["string", "null"],
                                                "enum": ["increasing", "decreasing", "unknown", None],
                                            },
                                            "src": {"type": ["string", "null"]},
                                            "body_src": {"type": ["string", "null"]},
                                            "init_src": {"type": ["string", "null"]},
                                            "body_is_block": {"type": ["boolean", "null"]},
                                ...
                                # Storage touches (key is optional)
                                "storage_reads": {
                                    "type": "array",
                                    "items": {
                                        "type": "object",
                                ...
                                # Length changes and local storage pointers
                                "length_effects": {
                                    "type": "array",
                                    "items": {
                                        "type": "object",
